...
<body>
     ...
     <?php if (empty($_SESSION["fort_sta"])){?>
        <div class="chooseBirthday">
        	...
        	<form action="" method="post" class="single">
            	...
            	<p>
            		<span class="btnM"><span class="btnText btnText2 singleSubmit cursorHand">提交</span></span>
            	</p>
            </form>
            <form action="" method="post" class="pair">
            	...
            	<p>
            		<span class="btnM"><span class="btnText btnText2 pairSubmit cursorHand">提交</span></span>
            	</p>
            </form>
        </div>
    ...
    <?php } ?>
        ...
        <div class="resultArea">
        	<img src="../img/index/constellation.png" alt="star" class="star">
