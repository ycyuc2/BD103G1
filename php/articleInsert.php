	...
	<?php
		...
		if ($confirm) {
			try {
				...
				$sql = "insert into article (teacher_no, art_title, art_content_1, art_content_2, art_content_3, art_img_1, art_img_2, art_img_3, art_post_time, art_update_time) values (:teacher_no, :art_title, :art_content_1, :art_content_2, :art_content_3, :art_img_1, :art_img_2, :art_img_3, :art_post_time, :art_update_time)";
